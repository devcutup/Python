"""Requirement 3 Solution console app """
...
file_name = "service_log.txt"   ## Define the file name (log) 
duration = 600              ## Define the duration of every checking time (s)

## check with service_detail for writing the statement
...
def write_file(service_Detail) :
    if check_to_write(service_Detail) == True :
        with open('service_log.txt', 'a') as file_handler :
            ...
            print ("Writed : " + service_Detail['service_name'] + " :: " + service_Detail['status'])
